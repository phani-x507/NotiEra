    ...
    return (
        <>
            ...
            <div className=" h-screen bg-gray-100 flex ">
                ...
                <div className=" border w-full border-blue-700 flex flex-col flex-wrap items-center justify-center">
                    ...
                    <div className=" h-[calc(100%-70px)] bg-white sm:w-full xl:w-[80%] p-2 overflow-y-auto flex flex-col items-center">
                        ...
                        <pre className=" text-xs xl:text-sm whitespace-pre-wrap break-words w-full md:w-[80%] lg:w-[80%] sm:w-full">{note.noteContent}</pre>
                    </div>
