            ...
            <div className="border h-screen bg-gray-100 flex ">
                ...
                <div className=" border-blue-700 flex-auto">
                    <>
                        ...
                        <div className="border p-3 mt-2 h-[calc(100%-75px)]  overflow-scroll">
                            ...
                            {SearchedNotes.map((note, index) => {
                                return (
                                    <button onClick={() => alert("Hello")} className="container min-h-[200px] sm:w-[250px] text-left cursor-pointer border border-gray-100 bg-white rounded rounded-xl w-fit p-3 m-1">
                                        ...
                                        <p className="text-[10px] text-gray-500 text-right mt-2 mb-1" >10-04-2024 8:56pm</p>
